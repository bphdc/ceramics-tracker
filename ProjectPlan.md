...
- [ ] Figure out what persistence classes I need and stub them out
- [ ] Figure out what controller classes I need and stub them out
- [ ] Figure out what entities i need and stub them out
- [ ] Create the config files for the DB connection info (dev and test)
- [ ] Create unit tests for at least one class
- [ ] Create a class for the DB connection business
- [ ] Update weekly reflections
- [ ] Add logging
- [ ] Make sure I hit everthing I need for the 2nd checkpoint
...
### Week 8
- [ ] Make sure I have whatever I need for 3rd checkpoint
